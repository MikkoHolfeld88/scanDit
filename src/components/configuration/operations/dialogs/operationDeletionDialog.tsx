...
export interface OperationDeletionDialogProps {
    handleDeletion: () => void;
    operationId: string;
...
export const OperationDeletionDialog = (props:OperationDeletionDialogProps) => {
    return (
        <Dialog open={props.open} onClose={() => props.setOpen(false)} maxWidth="xl" fullWidth>
            <DialogTitle>
                <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                    <Typography variant="body1">Really delete <b>{props.operationName}</b>?</Typography>
